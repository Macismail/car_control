...
public final class BedGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.protobuf.Empty,
      org.dominic.example.bed.DrsStatus> getLockDoorsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "lockDoors",
      requestType = com.google.protobuf.Empty.class,
      responseType = org.dominic.example.bed.DrsStatus.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.protobuf.Empty,
      org.dominic.example.bed.DrsStatus> getLockDoorsMethod() {
    io.grpc.MethodDescriptor<com.google.protobuf.Empty, org.dominic.example.bed.DrsStatus> getLockDoorsMethod;
    if ((getLockDoorsMethod = BedGrpc.getLockDoorsMethod) == null) {
      synchronized (BedGrpc.class) {
        if ((getLockDoorsMethod = BedGrpc.getLockDoorsMethod) == null) {
          BedGrpc.getLockDoorsMethod = getLockDoorsMethod = 
              io.grpc.MethodDescriptor.<com.google.protobuf.Empty, org.dominic.example.bed.DrsStatus>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "bed.Bed", "lockDoors"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.protobuf.Empty.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  org.dominic.example.bed.DrsStatus.getDefaultInstance()))
                  .setSchemaDescriptor(new BedMethodDescriptorSupplier("lockDoors"))
                  .build();
          }
        }
     }
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.protobuf.Empty,
      org.dominic.example.bed.AlarmStatus> getSwitchAlarmMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "switchAlarm",
      requestType = com.google.protobuf.Empty.class,
      responseType = org.dominic.example.bed.AlarmStatus.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.protobuf.Empty,
      org.dominic.example.bed.AlarmStatus> getSwitchAlarmMethod() {
    io.grpc.MethodDescriptor<com.google.protobuf.Empty, org.dominic.example.bed.AlarmStatus> getSwitchAlarmMethod;
    if ((getSwitchAlarmMethod = BedGrpc.getSwitchAlarmMethod) == null) {
      synchronized (BedGrpc.class) {
        if ((getSwitchAlarmMethod = BedGrpc.getSwitchAlarmMethod) == null) {
          BedGrpc.getSwitchAlarmMethod = getSwitchAlarmMethod = 
              io.grpc.MethodDescriptor.<com.google.protobuf.Empty, org.dominic.example.bed.AlarmStatus>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "bed.Bed", "switchAlarm"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.protobuf.Empty.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  org.dominic.example.bed.AlarmStatus.getDefaultInstance()))
                  .setSchemaDescriptor(new BedMethodDescriptorSupplier("switchAlarm"))
                  .build();
          }
        }
     }
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          ...
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.google.protobuf.Empty,
                org.dominic.example.bed.DrsStatus>(
          ...
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.google.protobuf.Empty,
                org.dominic.example.bed.AlarmStatus>(
  ...
  public static final class BedBlockingStub extends io.grpc.stub.AbstractStub<BedBlockingStub> {
    ...
    /**
     */
    public org.dominic.example.bed.DrsStatus lockDoors(com.google.protobuf.Empty request) {
      return blockingUnaryCall(
    ...
    /**
     */
    public org.dominic.example.bed.AlarmStatus switchAlarm(com.google.protobuf.Empty request) {
      return blockingUnaryCall(
  ...
  public static final class BedFutureStub extends io.grpc.stub.AbstractStub<BedFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<org.dominic.example.bed.DrsStatus> lockDoors(
        com.google.protobuf.Empty request) {
      return futureUnaryCall(
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<org.dominic.example.bed.AlarmStatus> switchAlarm(
        com.google.protobuf.Empty request) {
      return futureUnaryCall(
